Deel nooit je Private Sleutels
...
Het enige onderdeel van je Monero wallet wat je wellicht zou kunnen delen is je view-key (en dan ook alleen om te bewijzen dat een bepaalde transactie door jou ontvangen is). 
Als je dit niet nodig acht en/of wenst, deel dan geen van je sleutels. 

Als een persoon beweert dat hij/zij iets anders nodig heeft van je dan je wallet-adres (en in sommige gevallen dus ook deze view-key), dan proberen ze naar alle waarschijnlijkheid je op te lichten. 
