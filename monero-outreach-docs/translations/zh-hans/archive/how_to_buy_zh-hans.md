...
现金支票也提供了一定程度的隐私，因为它从字面上看是银行的支票，是从银行账户提取的，而不是从你的账户。但银行可以通过KYC监管政策获得你的信息，所以你要控制金额上限，要低于反洗钱阈值，所以这种方法也只是相对匿名的。
...
预付卡可以提供一定程度的隐私，只要卡片里没有你的个人信息。如果你用现金购买预付卡，并且不将其用于任何其他消费，你将拥有一定程度的隐私。
